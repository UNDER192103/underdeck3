...
:build_dist
echo.
echo Running: npm --prefix Electron run dist
call npm --prefix Electron run dist
goto end

:build_prod
echo.
echo Running: npm --prefix Electron run dist:prod
call npm --prefix Electron run dist:prod
goto end
