...
export class Shortcutkey extends EventEmitter {
    func_return_combo = null;
    listener;
    macros = new Map();
    alternativesMacros = new Map();
    started = false;
    constructor() {
        super();
    ...
    registerNewAlternativeMacro(shortcut) {
    ...
    async updateAlternativeMacros(shortcuts) {
    ...
    async updateDataMacros(shortcuts) {
        this.macros.clear();
        try {
            shortcuts.forEach(shortcut => {
